...
from prostab.utils.lr_scheduler import get_scheduler
from prostab.utils.optim import get_optimizer
...
utils.import_modules(os.path.dirname(__file__), "prostab.tasks")
